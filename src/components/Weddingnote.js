...
import './Weddingnote.css'

class Weddingnote extends Component {
  constructor(props) {
    super(props);
      ...
      <div className="container">
        ...
        <section className="crawl">
          <div className="content" ref={this.content}>
            ...
            <p className="">
              L'humain que vous êtes a de toute évidence de nombreuses qualités mais jamais sur Terre vous n'avez trouvé votre égal.
              Cela arrive parfois, quand la force en vous est trop forte, trop éclatante ou à l'opposée: si elle est trop faible ou camouflée par un défaut monstrueux
            ...
            <p>
             Une fois la première rencontre passée, nous ne doutons pas un seul instant de vous : sachez accepter la peau luisante
             ...
             L'amour inter espèce, c'est le TURFU. Faites parti de l'aventure, faites confiance à Kedusal, envoyez un mail à vos matchs.
            </p>
          </div>
        </section>
